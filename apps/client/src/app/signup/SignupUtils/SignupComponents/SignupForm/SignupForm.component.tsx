...
import { Err } from '../../../../../../src/app/twofa/TwofaUtils/TwofaComponents/err';
import {
  IRegistrate,
  IRegistrationFormProps,
} from '../../SignupInterfaces/Signup.interfaces';
  ...
  return (
    <form onSubmit={handleSubmit(onSubmitUserInfo)}>
      <SignupFormController
        ...
        type="text"
      />
      {errors.username && <Err msg={errors.username?.message as string} />}
      <SignupFormController
        control={control}
